...
### 🛠️ What I Do
- ⚙️ Design and optimize **RESTful microservices** with Spring Boot & Java
- 🌐 Build responsive, reusable **React.js** UI components
- ☁️ Deploy cloud-native apps on **AWS** (EC2, Lambda, S3, RDS, API Gateway)
- 🔁 Implement **CI/CD** pipelines with Jenkins, Docker & Kubernetes
- 🧩 Work with **GraphQL** and **Node.js** for API and backend development
...
- 📄 Published AI/ML research - *A One-Stop Service Provider for Farmers Using Machine Learning* (Springer, 2023)
